...
public class Pokemon implements Registrable{
    ...
    public Pokemon(String charmeleon, Region kantho, Attack charmanderFastAttack, Attack charmanderChargeAttack){
    ...
    public String getInformation() {
        ...
        /*"Pokemon Type: " +*/ this.getTypesAsString() + /*"\n"+*/
                "Fast Attack: " + this.fastAttack.getName() + "\n"+
                "Charge Attack: " + this.chargeAttack.getName() + "\n";
    ...
    private String getTypesAsString (){
        String result = "";
        for(Type type: types){
            result = result + "" + type.getTypeDetailInfo();
        }
        return result;
    }
